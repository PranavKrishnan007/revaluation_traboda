    ...
    return (
        <nav className="bg-transparent px-2 sm:px-4 py-2.5 rounded-b">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                <a href="https://flowbite.com/" className="flex items-center ml-5">
                    <img src="harry.jpeg" className="h-6 mr-5 sm:h-9 rounded-full"
                         alt="harry potter logo"/>
                    <span
                        className="self-center font-extrabold text-transparent text-2xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Harry Potter Wiki</span>
                </a>
